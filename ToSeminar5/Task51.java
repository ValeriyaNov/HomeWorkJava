...
public class Task51 {
    public static void main(String[] args){
        ...
        System.out.println("Введите имя и номер контакта");//имя вводим без пробелов, после имени ставим запятую и без пробелов вводим номер(в виде целовго числа без дополнительных знаков), например 'Ivan,896666666'
